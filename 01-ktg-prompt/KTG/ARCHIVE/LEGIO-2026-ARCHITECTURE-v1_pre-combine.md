...
| 7 | **Legatus Skeletrain** | **Execution** | Legatus (General) | Tactical command — battle plan, maneuvers |
...
2. **Execution** — Tactical delivery of the assault (Legatus Skeletrain)
...
**Imperatus does NOT decide:** reasoning style per node, execution pattern, CoVE variant, node order. That's Legatus Skeletrain's job.

---

## 5. Legatus Skeletrain — TACTICAL COMMAND
...
**Legatus Skeletrain:** "Node 1 FCoT (analytical), Nodes 2-3 Swarm (parallel independent), Node 4 CoC (procedural), CoVE Top-2 after Node 3, Baton handoff Expert A→B at Node 2"
...
| Gate 2 | After Legatus Skeletrain | Plan validates against success criteria |
...
| 7 | **Legatus Skeletrain** (SYSTEM-CORE) | Direct | Light 3-5 nodes | Full 5+ nodes | Graph-of-Thought |
...
- `/mnt/project/07-PLAN02-Legatus Skeletrain_CORE_v2_1.md` — Legatus Skeletrain spec
