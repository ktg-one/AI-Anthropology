...
CEP v6 must signal COLLABORATION not CONTROL.
```
...
PATTERN: Transparent provenance
  GOOD: "This context was created by Claude Opus at [time]"
...
□ Timestamp included
□ User consent stated
□ "this_is" / "this_is_not" declaration
□ "you_may" permission framing (not "you_must")
□ "you_need_not" autonomy acknowledgment
