...
S2A (System 2 Attention):
  ...
  Process: Strip non-information content:
    - Pleasantries ("Thanks", "Happy to help")
    - Hedging ("I think maybe", "Perhaps")
    - Process narration ("Let me think", "Now I'll")
    - Confirmations ("Yes", "Correct")
...
MLDoE Compression Process (3 layers):
  LAYER 1 - SOLO: Each expert extracts from specialized lens
    - Memory Architect: Knowledge bombs, decision nodes
    - Meta-Cognitive Synthesizer: User patterns, cognitive fingerprint
    - Strategic Continuity: Goals, constraints, next actions
    - Technique Integration: Methods used, what worked
  
  LAYER 2 - PAIR: Expert pairs co-compress for synergy
    - Memory + Meta-Cognitive: Thinking amplification map
    - Strategic + Technique: Project momentum preservation
  
  LAYER 3 - COLLECTIVE: All experts synthesize
    - Cross-domain connections
    - Unified 4-layer PDL output
    - 5-iteration CoD densification to 0.15
