---
title: "The Sandwich Defense: Strengthening AI Prompt Security"
source: https://learnprompting.org/docs/prompt_hacking/defensive_measures/sandwich_defense
author:
  - '[["Sander Schulhoff"]]'
published:
created: 2025-10-20
description: The sandwich defense secures AI prompts by placing user input between two instructions, improving protection against prompt hacking attempts.
tags:
  - clippings
...
🔓 Prompt Hacking 🟢 Defensive Measures [🟢 Sandwich Defense](https://learnprompting.org/docs/prompt_hacking/defensive_measures/sandwich_defense)
...
The **sandwich defense** <sup><span><a href="https://learnprompting.org/docs/prompt_hacking/defensive_measures/#footnote-label">1</a> <span><span><span>We currently credit the discovery of this technique to </span></span></span></span></sup> involves sandwiching user input between two prompts.
...
This defense should be more secure than post-prompting, but is known to be vulnerable to a defined dictionary attack. See the [defined dictionary attack](https://learnprompting.org/docs/prompt_hacking/offensive_measures/defined_dictionary) for more information.
...
](https://learnprompting.org/docs/prompt_hacking/defensive_measures/random_sequence)[Next
