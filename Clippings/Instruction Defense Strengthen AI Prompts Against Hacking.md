---
title: "Instruction Defense: Strengthen AI Prompts Against Hacking"
source: https://learnprompting.org/docs/prompt_hacking/defensive_measures/instruction
author:
  - '[["Sander Schulhoff"]]'
published:
created: 2025-10-20
description: Learn about the instruction defense, a method for securing AI prompts by appending warnings to safeguard against malicious user input and prompt hacking attempts.
tags:
  - clippings
...
🔓 Prompt Hacking 🟢 Defensive Measures [🟢 Instruction Defense](https://learnprompting.org/docs/prompt_hacking/defensive_measures/instruction)
...
**The instruction defense** is a way of instructing prompts explicitly to be wary of attempts to use different hacking methods. You can add [instructions](https://learnprompting.org/docs/basics/instructions) to a prompt which encourage the model to be careful about what comes next in the user input.
