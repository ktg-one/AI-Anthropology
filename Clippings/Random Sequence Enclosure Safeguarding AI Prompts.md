---
title: "Random Sequence Enclosure: Safeguarding AI Prompts"
source: https://learnprompting.org/docs/prompt_hacking/defensive_measures/random_sequence
author:
  - '[["Sander Schulhoff"]]'
published:
created: 2025-10-20
description: Enhance your AI's security with random sequence enclosure, a method that places user input between random strings to prevent prompt hacking attempts.
tags:
  - clippings
...
🔓 Prompt Hacking 🟢 Defensive Measures [🟢 Random Sequence Enclosure](https://learnprompting.org/docs/prompt_hacking/defensive_measures/random_sequence)
...
**Random sequence enclosure** is yet another defense. This method encloses the user input between two random sequences of characters <sup><span><a href="https://learnprompting.org/docs/prompt_hacking/defensive_measures/#footnote-label">1</a> <span><span><span>Stuart Armstrong, R. G. (2022). Using GPT-Eliezer against ChatGPT Jailbreaking. <a href="https://www.alignmentforum.org/posts/pNcFYZnPdXyL2RfgA/using-gpt-eliezer-against-chatgpt-jailbreaking">https://www.alignmentforum.org/posts/pNcFYZnPdXyL2RfgA/using-gpt-eliezer-against-chatgpt-jailbreaking</a></span></span></span></span></sup>.
...
](https://learnprompting.org/docs/prompt_hacking/defensive_measures/post_prompting)[Next
