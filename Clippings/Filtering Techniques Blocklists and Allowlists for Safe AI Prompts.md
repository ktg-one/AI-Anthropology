---
title: "Filtering Techniques: Blocklists and Allowlists for Safe AI Prompts"
source: https://learnprompting.org/docs/prompt_hacking/defensive_measures/filtering
author:
  - '[["Sander Schulhoff"]]'
published:
created: 2025-10-20
description: Learn about filtering techniques like blocklists and allowlists for preventing prompt hacking and moderating AI systems to block harmful or biased content.
tags:
  - clippings
...
🔓 Prompt Hacking 🟢 Defensive Measures [🟢 Filtering](https://learnprompting.org/docs/prompt_hacking/defensive_measures/filtering)
...
**Filtering** is a common technique for preventing prompt hacking <sup><span><a href="https://learnprompting.org/docs/prompt_hacking/defensive_measures/#footnote-label">1</a> <span><span><span>Kang, D., Li, X., Stoica, I., Guestrin, C., Zaharia, M., &amp; Hashimoto, T. (2023). Exploiting Programmatic Behavior of LLMs: Dual-Use Through Standard Security Attacks. </span></span></span></span></sup> . There are a few types of filtering, but the basic idea is to check for words and phrases in the initial prompt or the output that should be blocked. You can use a blocklist or an allowlist for this purpose <sup><span><a href="https://learnprompting.org/docs/prompt_hacking/defensive_measures/#footnote-label">2</a> <span><span><span>Selvi, J. (2022). Exploring Prompt Injection Attacks. <a href="https://research.nccgroup.com/2022/12/05/exploring-prompt-injection-attacks/">https://research.nccgroup.com/2022/12/05/exploring-prompt-injection-attacks/</a></span></span></span></span></sup>.
...
](https://learnprompting.org/docs/prompt_hacking/defensive_measures/introduction)[Next
