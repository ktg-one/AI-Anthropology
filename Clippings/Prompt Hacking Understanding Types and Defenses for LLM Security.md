---
title: "Prompt Hacking: Understanding Types and Defenses for LLM Security"
source: https://learnprompting.org/docs/prompt_hacking/introduction
author:
  - '[["Sander Schulhoff"]]'
published:
created: 2025-10-20
description: "Learn about prompt hacking, where attackers manipulate prompts to exploit LLM vulnerabilities. Discover key types: prompt injection, leaking, jailbreaking, and defenses."
tags:
  - clippings
feature: thumbnails/external/583c124b4d8aa96dc71c68d111f94da3.webp
thumbnail: thumbnails/resized/5e1d15d626ee7b827f205f4a53c4381f_86cf658e.webp
---
...
![prompt hacking lock](https://learnprompting.org/_next/image?url=%2Fimg%2Flock.webp&w=750&q=75&dpl=dpl_53nbXmh4CtwZKjCjh9ewYWDsukmX)
...
In this section of our guide, we will cover three main types of prompt hacking: prompt [injection](https://learnprompting.org/docs/prompt_hacking/injection), prompt [leaking](https://learnprompting.org/docs/prompt_hacking/leaking), and [jailbreaking](https://learnprompting.org/docs/prompt_hacking/jailbreaking). Each relates to slightly different vulnerabilities and attack vectors, but all are based on the same principle of manipulating the LLM's prompt to generate some unintended output.

### Offensive and Defensive Measures

We will also cover both [offensive](https://learnprompting.org/docs/prompt_hacking/offensive_measures/introduction) and [defensive](https://learnprompting.org/docs/prompt_hacking/defensive_measures/introduction) measures for prompt hacking.
...
- [Prompt Hacking: A Comprehensive Guide](https://learnprompting.org/docs/prompt_hacking/introduction)
- [Offensive Measures](https://learnprompting.org/docs/prompt_hacking/offensive_measures/introduction)
- [Defensive Measures](https://learnprompting.org/docs/prompt_hacking/defensive_measures/introduction)### [🟢 Defensive Measures](https://learnprompting.org/docs/prompt_hacking/defensive_measures/introduction)
...
](https://learnprompting.org/docs/prompt_hacking/offensive_measures/introduction)
...
](https://learnprompting.org/docs/reliability/math)[Next
