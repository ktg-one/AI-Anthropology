---
title: "Post-Prompting: Strengthening AI Against Prompt Injection"
source: https://learnprompting.org/docs/prompt_hacking/defensive_measures/post_prompting
author:
  - '[["Sander Schulhoff"]]'
published:
created: 2025-10-20
description: Learn how post-prompting enhances AI security by placing user input before the instruction, making models less vulnerable to prompt hacking like injection attacks.
tags:
  - clippings
...
🔓 Prompt Hacking 🟢 Defensive Measures [🟢 Post-Prompting](https://learnprompting.org/docs/prompt_hacking/defensive_measures/post_prompting)
...
The **post-prompting** defense <sup><span><a href="https://learnprompting.org/docs/prompt_hacking/defensive_measures/#footnote-label">1</a> <span><span><span>Mark, C. (2022). Talking to machines: prompt engineering &amp; injection. <a href="https://artifact-research.com/artificial-intelligence/talking-to-machines-prompt-engineering-injection/">https://artifact-research.com/artificial-intelligence/talking-to-machines-prompt-engineering-injection/</a></span></span></span></span></sup> simply puts the user input *before* the prompt.
...
Post-prompting, although seemingly simple, is yet another effective defense against prompt hacking methods like prompt [injection](https://learnprompting.org/docs/prompt_hacking/injection). This technique takes advantage of the fact that the model is more inclined to follow the last instruction it sees.
...
](https://learnprompting.org/docs/prompt_hacking/defensive_measures/instruction)[Next
