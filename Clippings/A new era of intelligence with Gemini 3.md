...
source: https://blog.google/products/gemini/gemini-3/#plan-anything
author:
  - "[[Sundar Pichai]]"
published: 2025-11-19
created: 2025-11-19
description: Today we’re releasing Gemini 3 – our most intelligent model that helps you bring any idea to life.
tags:
  - clippings
feature: thumbnails/external/9a8fe98cc48f3ef09aae4f3aea022f09.failed.png
thumbnail: thumbnails/resized/d67fa8ea05a07613a6b73e36ce71cc34_86cf658e.webp
---
Nov 18, 2025
...
![Gemini 3 logo in front of a black background with the number 3 in blue dots](https://storage.googleapis.com/gweb-uniblog-publish-prod/images/gemini-3_model-blog_header-dark.width-800.format-webp.webp)
...
![Gemini 3 evaluation table against other AI models](https://storage.googleapis.com/gweb-uniblog-publish-prod/original_images/gemini_3_table_final_HLE_Tools_on.gif)
...
![Evaluation chart for Gemini 3 Deep Think](https://storage.googleapis.com/gweb-uniblog-publish-prod/original_images/final_dt_blog_evals_2.gif)

Gemini 3 Deep Think mode excels on some of the most challenging AI benchmarks. See details on our evaluation methodology.
...
<video type="video/mp4" aria-label="A corkboard covered in handwritten family recipes and notes in Korean, some on yellowed paper and a blue envelope." src=" https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/Gemini3_FamilyRecipes_nologo.mp4 ">Sorry, your browser doesn't support embedded videos, but don't worry, you can <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/Gemini3_FamilyRecipes_nologo.mp4">download it</a> and watch it with your favorite video player!</video>

Gemini 3 can help you learn and preserve family cooking traditions. Try it in Gemini Canvas.
...
You can now [build with Gemini 3](https://blog.google/technology/developers/gemini-3-developers) in Google AI Studio, Vertex AI, Gemini CLI and our new agentic development platform, Google Antigravity. It’s also available in third-party platforms like Cursor, GitHub, JetBrains, Manus, Replit and more.

<video type="video/mp4" aria-label="Retro 3D spaceship game demo using Gemini 3" src=" https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/Gemini3_RetroGame_nologo.mp4 ">Sorry, your browser doesn't support embedded videos, but don't worry, you can <a href="https://storage.googleapis.com/gweb-uniblog-publish-prod/original_videos/Gemini3_RetroGame_nologo.mp4">download it</a> and watch it with your favorite video player!</video>

Code a retro 3D spaceship game with richer visualizations and improved interactivity. Try it in AI Studio.

### Introducing a new agent-first development experience

As model intelligence accelerates with Gemini 3, we have the opportunity to reimagine the entire developer experience. Today we’re releasing [Google Antigravity](http://antigravity.google/), our new agentic development platform that enables developers to operate at a higher, task-oriented level.
...
Since introducing the agentic era with Gemini 2, we’ve made a lot of progress, not only advancing Gemini’s coding agent abilities, but also improving its ability to reliably plan ahead over longer horizons. Gemini 3 demonstrates this by topping the leaderboard on [Vending-Bench 2](https://andonlabs.com/evals/vending-bench-2), which tests longer horizon planning by managing a simulated vending machine business. Gemini 3 Pro maintains consistent tool usage and decision-making for a full simulated year of operation, driving higher returns without drifting off task.

![Chart showing Gemini 3 Pro outperforming other AI models on long-horizon planning](https://storage.googleapis.com/gweb-uniblog-publish-prod/images/vending_bench_2_final.width-1000.format-webp.webp)
...
Google AI Ultra subscribers can try these agentic capabilities in the Gemini app with [Gemini Agent](https://blog.google/products/gemini/gemini-3-gemini-app) today. We’ve learned a lot improving Gemini’s agentic capabilities, and we’re excited to see how you use it as we expand to more Google products soon.
...
In addition to our in-house testing for the critical domains in our [Frontier Safety Framework](https://deepmind.google/discover/blog/strengthening-our-frontier-safety-framework/), we've also partnered on evaluations with world-leading subject matter experts, provided early access to bodies like the UK AISI, and obtained independent assessments from industry experts like Apollo, Vaultis, Dreadnode and more. For more information, see the [Gemini 3 model card](http://deepmind.google/models/model-cards/gemini-3-pro).

## The next era of Gemini

This is just the start of the Gemini 3 era. As of today, Gemini 3 starts rolling out:

- For everyone in the [Gemini app](https://blog.google/products/gemini/gemini-3-gemini-app) and for Google AI Pro and Ultra subscribers in [AI Mode](http://blog.google/products/search/gemini-3-search-ai-mode) in Search
- For [developers](https://blog.google/technology/developers/gemini-3-developers) in the Gemini API in AI Studio, our new agentic development platform, Google Antigravity; and Gemini CLI
- For [enterprises](https://cloud.google.com/blog/products/ai-machine-learning/gemini-3-is-available-for-enterprise) in Vertex AI and Gemini Enterprise
